...
### 주방
	- 수전: 아메리칸스탠다드 웨이브로 변경
	- 바 테이블 조명 배선 측면, 천장 다 시공
	- 냉장고 옆 정수기 설치 관련 수도 추가
	- 싱크대 분쇄기 설치 업체 추천
	- 주방 하부장 높이 확인(최대한 높여서 950으로 정한 걸로 기억하고 있습니다.)

### 안방
	- 파우더룸 스위치 르그랑 엑셀 스위치(화이트)로 변경
	- 안방 창호 투명으로 변경
	- 침대 프레임 필름 작업은 일정 조율해서 이사가기 전 집에서 진행
	- 형광등(안방, 거실) 보존가능 여부(수요일) 까지만 보관(이사나가시는 분이 가져가실 수 있음)
	- 가벽 포인트벽지 높이 1700으로 변경
...
### 거실
	...
	- TV 설치 관련 벽 보강작업 견적 확인해주시면 주말까지 고민해보겠습니다.
